...
impl<'a, A: PartialEq + AD, T> PartialEq for RefWithCost<'a, A, T> {
    #[inline]
...
impl<'a, A: PartialEq + AD, T> Eq for RefWithCost<'a, A, T> {}

impl<'a, A: PartialOrd + AD, T> PartialOrd for RefWithCost<'a, A, T> {
    #[inline]
...
impl<'a, A: PartialOrd + AD, T> Ord for RefWithCost<'a, A, T> {
    #[inline]
